...
#if (TIMER2_ENABLED == 1)
#define TIMER2_CONFIG_FREQUENCY    NRF_TIMER_FREQ_1MHz
#define TIMER2_CONFIG_MODE         TIMER_MODE_MODE_Counter
...
#if (TIMER3_ENABLED == 1)
#define TIMER3_CONFIG_FREQUENCY    NRF_TIMER_FREQ_1MHz
#define TIMER3_CONFIG_MODE         TIMER_MODE_MODE_Counter
